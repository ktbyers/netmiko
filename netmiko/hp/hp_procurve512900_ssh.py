...
class HPProcurve512900SSH(CiscoSSHConnection):
    ...
    def enable(self, cmd='_cmdline-mode on\nY\n512900', pattern='password', re_flags=re.IGNORECASE,
    ...
    def save_config(self, cmd='write memory', confirm=False):
        """Save Config."""
        return super(HPProcurve512900SSH, self).save_config(cmd=cmd, confirm=confirm)
