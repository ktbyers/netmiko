...
class AudiocodeSSH(BaseConnection):
    ...
    def check_enable_mode(self, check_string="#"):
        ...
        """
        return super(AudiocodeSSH, self).check_enable_mode(check_string=check_string)
    ...
    def exit_enable_mode(self, exit_command="disable"):
        ...
        """
        return super(AudiocodeSSH, self).exit_enable_mode(exit_command=exit_command)
    ...
    def disable_paging(
        ...
        self.send_config_set(
            disable_window_config, True, 0.25, 150, False, False, config_mode
        )
    ...
    def _enable_paging(
        ...
        self.send_config_set(
            enable_window_config, True, 0.25, 150, False, False, config_mode
        )
