...
class SCPConn(object):
    ...
    def establish_scp_conn(self) -> None:
        ...
        assert isinstance(self.ssh_ctl_chan.channel, SSHChannel)
        scp_conn_pre = self.ssh_ctl_chan.channel._build_ssh_client()
        # Drop some unneeded parameters
        ssh_connect_params.pop("blocking_timeout")
        ssh_connect_params.pop("keepalive")
        self.scp_conn = scp_conn_pre.connect(**ssh_connect_params)
