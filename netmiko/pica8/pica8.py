...
class pica8Base(BaseConnection):
    ...
    def session_preparation(self):
        ...
        time.sleep(0.8 * self.global_delay_factor)
        self.clear_buffer()
...
class pica8FileTransfer(BaseFileTransfer):
    ...
    def __init__(
        ...
        return super(pica8FileTransfer, self).__init__(
            ssh_conn=ssh_conn,
    ...
    def remote_md5(self, base_cmd="file checksum md5", remote_file=None):
        return super(pica8FileTransfer, self).remote_md5(
