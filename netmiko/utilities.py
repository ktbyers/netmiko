...
def initiate_session_log(session_log):
    ...
    Raises ValueError if session_log is not a valid logger object or [path/]filename
    """
    try:
    ...
    try:
        ...
        # Attribute error if provided session_log is not a valid path, OSError if unable to create file handler
