...
latex_documents = [
    (master_doc, "Netmiko.tex", u"Netmiko Documentation", u"Kirk Byers", "manual")
]
...
man_pages = [(master_doc, "netmiko", u"Netmiko Documentation", [author], 1)]
